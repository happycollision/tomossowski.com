<script lang="ts" context="module">
  ...
  export const title = "Interviews about teaching in China"
</script>

<Markdown
  source="{`
Tom was interviewed by two publications about his trip to Beijing to bring
western musical theatre to China.
